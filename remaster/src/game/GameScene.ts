...
export class GameScene extends Phaser.Scene {
  ...
  private createHud(): void {
    ...
    // back button inside the scoreboard, left of the remaining seconds
    addBackButton(this, 56, 54, 62);
    this.timerText = this.add.text(102, 22, "", { ...style, fontSize: "34px" }).setDepth(51);
    this.scoreText = this.add
      .text(GAME_WIDTH - 28, 22, "", { ...style, fontSize: "34px", color: "#ffb347" })
      .setOrigin(1, 0)
      .setDepth(51);
    this.streakText = this.add
      .text(102, 60, "", { ...style, fontSize: "24px", color: "#8ee6d8" })
      .setDepth(51);
    this.updateHud();
  }
